"""
Django settings for FARMbit project.
...
SECRET_KEY = 'django-insecure-*8d%a3q303u#ax#en(9z+!xqa=xy(xq_m8f6=l+eho3()hcg!)'
...
WSGI_APPLICATION = 'FARMbit.wsgi.application'
